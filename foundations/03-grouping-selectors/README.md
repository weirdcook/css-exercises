...
### Self Check
- Does each element have a unique class name? check!
- Did you use the grouping selector for styles that both elements share? check!
- Did you make separate rules for the styles unique to each element? check!
